structure(list(method = "GET", url = "https://api.postcodes.io/terminated_postcodes/HD1%202UV", 
    status_code = 404L, headers = structure(list(Date = "Tue, 12 Mar 2024 18:18:22 GMT", 
    ...
    request = structure(list(url = "https://api.postcodes.io/terminated_postcodes/HD1%202UV", 
