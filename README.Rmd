...
The goal of LSOApop is to make population estimates for Lower layer Super Output Areas easily available in R.
These population estimates will be available by age (0 to 90+) and gender (female/male).

## Installation

You can install the released version of LSOApop from [GitHub](https://github.com/) with:
