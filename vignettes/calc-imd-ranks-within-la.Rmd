...
The pages built here https://nhs-r-community.github.io/LSOApop/ have been done using the package [{pkgdown}](https://pkgdown.r-lib.org/). In order to rebuild the pages after any changes use `pkgdown::build_site()` in the console. There will be a number of changes to the supporting files in the folder `docs/` which all then need to be committed.
